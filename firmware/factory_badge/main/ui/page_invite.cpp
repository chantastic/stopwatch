...
public:
    InvitePage(Context& context, lv_obj_t* parent) : PageView(context, parent) {
        label(root_, "Developers", 54, 80, 360, &font_sans_32);
        label(root_, "After Dark", 54, 122, 360, &font_sans_32);
        ...
        label(root_, "Invite details coming soon", 64, 368, 340, &font_mono_semibold_12, muted());
    }
};
